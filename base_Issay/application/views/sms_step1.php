				...
				<div class="row">
					<div class="12u">
						...
						<section class="dash-container" >
							...
							<div id="stepsdiv" >
								<div class="steps stepfirst" >
									<div class="stepcontActive" style="padding: 12px 0px 0px 27px;"><?php echo $step_select_mem;?></div>
						...
						<div class="clear" ></div>
							...
							echo form_open('sms/step1Action', $attributes);
							?>
							<?php 
							$tgps = 0;
							if(!empty($mgroups)){
								...
								<div id="uploadResult" >
									<table class="table-data" >
										<tr style="background:#F9F9F9;font-weight: 500;">
											<th width="10%" align="center" ><input type="checkbox" name="checkall1" id="checkall1" value="" /></th>
							...
							<div id="uploadResult" >
								<table class="table-data" >
									...
									?>
									<tr>
										<td align="center" ><input type="checkbox" name="check[]" id="check" value="<?php echo $user->member_id;?>" class="checkbox" <?php echo $sel;?> /></td>
