				...
				<div class="row">
					<div class="12u">
						...
						<section class="dash-container" >
							...
							<div id="stepsdiv" >
								...
								<div class="steps stepother" >
									...
									<div class="stepcontActive"  style="padding: 12px 0px 0px 15px;"><?php echo $step_select_text;?></div>
								</div>
								<div class="steps stepother" >
						...
						<div class="clear" ></div>
							...
							echo form_open('sms/step2Action', $attributes);
							?>
							<div id="uploadResult">
								<table style="width:100%" >
									<tr style="background:#F9F9F9;font-weight: 500;">
										...
										<td width="50%" align="center" ><?php echo $text_label;?></td>
									</tr>
									<?php 
							...
							<div class="formBtnGroup" style="padding: 20px 0px;" >
								...
								<a class="btn-primary" style="float:left; padding: 5px 22px;" href="<?php echo site_url("sms/step1").'?sid='.$_GET['sid'];?>" ><?php echo $back_btn;?></a>
