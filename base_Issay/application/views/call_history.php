					...
					<div class="12u">
						...
						<section class="dash-container" >
							<div class="12u">
								...
								echo form_open('phonecall/history', $attributes);
								?>
								...
								<table class="table-data_dash" >
									<tr>
										...
										<th width="5%" align="center" ><?php echo $preview;?></th>
		...
		if(data != ''){
			...
			for (i in data) {
				...
				if(op == 'sms'){
					...
					if(dlst == '2'){sts = '<?php echo $status_failed;?>';rsnd = '<a href="#" id="rsndbtnsms'+smid+'" onclick="resendSMS('+smid+', '+sid+')" class="btn-primary" ><?php echo $resend_btn;?></a>';}
