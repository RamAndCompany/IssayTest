				...
				<div class="row">
					<div class="12u">
						...
						<div class="clear" ></div>
							...
							echo form_open('sms/step3Action', $attributes);
							?>
							<div class="voicePanel" >
								<div class="formLabel left" style="width:20%" >
							...
							<div class="voicePanel" id="calPanel" >
							...
							<div class="voicePanel" style="padding:8px;width:48%;float:left;margin-left:4%;" >
							...
							<div class="formBtnGroup" >
								...
								<a class="btn-primary" style="float:left; padding: 6px 22px;" href="<?php echo site_url("sms/step2").'?sid='.$_GET['sid'];?>" ><?php echo $back_btn;?></a>
								<input type="submit" class="btn-primary" name="btn" id="btn" value="<?php echo $continue_btn;?>" onclick="return saveForm()" style="float:right;" />
								<div class="clear"></div>
							</div>
							</form>
