				...
				<div class="row">
					<div class="12u">
						...
						<section class="dash-container" >
							...
							<div class="w90 mc">
								<section>
									<div style="text-align:center" ><?php echo $call_success;?></div>
										...
										<div class="formBtnGroup" style="width: 50%; margin-left: auto;margin-right: auto;" >
											...
											<a class="btn-primary"  href="<?php echo site_url('phonecall/step1');?>" ><?php echo $return_call;?></a>
										</div>
								</section>
							</div>
